...
function command(name, value) {
  ...
  if (['become-op','area-acquire','area-item-shop','item-preview','area-quest-open','area-quest-accept','area-deep','area-location','area-scan','area-shop','area-monster','area-quests','area-plan','area-go','area-cancel','gear-inspect','gear-find','gear-go','quest-refresh','quest-go','quest-catalog','catalog-farm','catalog-go','active-quests','active-quest-go','active-quest-open','cancel-active-quest','achievements','achievements-refresh','achievements-go'].includes(name)) {
