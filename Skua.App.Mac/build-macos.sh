...
/usr/libexec/PlistBuddy -c 'Set :CFBundleShortVersionString 0.2.0' "$skua_app/Contents/Info.plist"
/usr/libexec/PlistBuddy -c 'Set :CFBundleVersion 2' "$skua_app/Contents/Info.plist"
